PROGRAM 6: Write a program using a cursor to insert the records of
employees in the EMP_BACKUP table for given DEPT_NO, also raise a
user-defined exception NO_DEPT_FOUND when no records are found for
entered DEPT_NO.
--------------------------------------------------------
